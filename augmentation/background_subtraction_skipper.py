...
parser.add_argument("-fs","--frame_skipper", help="Reads every # frame. Defaults to 50.",default=50,type=int)
...
frame_skipper = args.frame_skipper
#differenced parameters
...
for im_num in im_num_list:
    ...
    #cap.set(cv2.CAP_PROP_POS_FRAMES, max(0,target_frame-lead_in*frame_skipper))
    ...
    for frame_number in range(max(0,target_frame-(lead_in)*frame_skipper), target_frame+frame_skipper, frame_skipper):
        ...
        #if frame_count % frame_skipper == 0:

...
#argument library
import argparse
parser = argparse.ArgumentParser(description='This script performs background subtraction on images with surrounding images \
...
parser.add_argument("-td","--threshold_dist", help="Distance to threshold for KNN background subtraction. Defaults to 400.",default=400,type=int)
parser.add_argument("-li","--lead_in", help="Length of the history for KNN background subtraction. Defaults to 500.",default=500,type=int)
